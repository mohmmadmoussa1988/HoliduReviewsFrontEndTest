...
describe("App reducer", () => {
  ...
  it("should set SHOW_LOADING to true on FETCH_REVIEWS_START", () => {
    expect(
  ...
  it("should set RESULTS and COUNT  on FETCH_REVIEWS_SUCCESS", () => {
    const reviews = [
      {
  ...
  it("should set ERROR to error value on FETCH_REVIEWS_FAILURE", () => {
    expect(
      appReducer(INITIAL_STATE, {
